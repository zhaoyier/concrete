...
func (e *Entry) Printf(format string, args ...interface{}) {
	e.Entry.WithField("call", String(e.depth+1)).Printf(format, args...)
}

func (e *Entry) Println(args ...interface{}) {
	e.Entry.WithField("call", String(e.depth+1)).Println(args...)
}

func (e *Entry) Debug(args ...interface{}) {
	e.Entry.WithField("call", String(e.depth+1)).Debug(args...)
}

func (e *Entry) Debugf(format string, args ...interface{}) {
	e.Entry.WithField("call", String(e.depth+1)).Debugf(format, args...)
}

func (e *Entry) Fatal(args ...interface{}) {
	e.Entry.WithField("call", String(e.depth+1)).Fatal(args...)
}

func (e *Entry) Fatalf(format string, args ...interface{}) {
	e.Entry.WithField("call", String(e.depth+1)).Fatalf(format, args...)
}

func (e *Entry) Info(args ...interface{}) {
	e.Entry.WithField("call", String(e.depth+1)).Info(args...)
}

func (e *Entry) Infof(format string, args ...interface{}) {
	e.Entry.WithField("call", String(e.depth+1)).Infof(format, args...)
}

func (e *Entry) Warn(args ...interface{}) {
	e.Entry.WithField("call", String(e.depth+1)).Warn(args...)
}

func (e *Entry) Warnf(format string, args ...interface{}) {
	e.Entry.WithField("call", String(e.depth+1)).Warnf(format, args...)
}
...
func (e *Entry) Errorf(format string, args ...interface{}) {
	...
	e.Entry.WithField("call", String(e.depth+1)).Error(err)
}

func (e *Entry) ErrorMsg(args ...interface{}) {
	e.Entry.WithField("call", String(e.depth+1)).Error(args...)
}
